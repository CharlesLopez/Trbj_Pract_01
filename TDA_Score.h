...
int AgregarTiro(TDA_Score* score, char[3] detalle, int posicion) /*Recibe un TDA_Score inicializado, un detalle del tiro (que puede tener uno o dos o tres caracteres) y la posición de ejecución (1 a 10), en caso de falla o éxito devuelve el código correspondiente.*/
...
int establecerParticipante(TDA_Score* score, char[20] nombreUsuario) /*Recibe un TDA_Score inicializado y establece el nombre de usuario recibido por parametro, en caso de falla o éxito devuelve el código correspondiente*/
