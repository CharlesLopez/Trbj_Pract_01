...
long s_calcularResultado(TDA_Score score); /*Recibe un TDA_Score inicializado, y devuelve la puntuación obtenida, en caso de falla devuelve un código entero negativo, con los numeros de linea que tienen la falla.*/
...
char* s_obtenerParticipante(TDA_Score* score) ; /*Recibe un TDA_Score inicializado y devuelve el nombre de usuario */
