...
int calcularResultado(TDA_Score score){
    int aux1,cont,i,j,strikes;
    for(i=1;i<11;i++){
        strikes=0;
        for(j=1;i<4;i++){
            switch (score.jugada[i][j]){
                case '1': aux1=1; cont=cont+aux1; break;
                case '2': aux1=2; cont=cont+aux1; break;
                case '3': aux1=3; cont=cont+aux1; break;
                case '4': aux1=4; cont=cont+aux1; break;
                case '5': aux1=5; cont=cont+aux1; break;
                case '6': aux1=6; cont=cont+aux1; break;
                case '7': aux1=7; cont=cont+aux1; break;
                case '8': aux1=8; cont=cont+aux1; break;
                case '9': aux1=9; cont=cont+aux1; break;
            }
        }
    }
    return cont;
